...
The helper function accepts an Axes object rather than creating a new Figure, allowing the same drawing to be reused across subplots. Below, one loop places three gauges on three Axes. You might prefer to make further modifications to the sizing and spacing, because the tick labels are crowded in these smaller panels.
