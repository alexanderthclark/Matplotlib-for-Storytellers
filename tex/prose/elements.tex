...
Another useful method is \code{get_window_extent()}, which allows you to find the bounding box for something added to a plot. This can be used to find the coordinates for where an annotate begins or ends, for example. 